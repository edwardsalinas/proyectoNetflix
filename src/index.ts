...
const userLists = new Map<string, UserList>();
const watchHistory = new Map<string, WatchHistoryEntry[]>();
...
// Get Movie
app.get('/movies/:movieId', (req: Request, res: Response): void => {
...
app.get('/movies', (req: Request, res: Response): void => {
  const input: ListMoviesInput = req.query as any;
  ...
  const response: ListMoviesOutput = {
...
// Update Movie
app.put('/movies/:movieId', (req: Request, res: Response): void => {
  const { movieId } = req.params;
...
// Delete Movie
app.delete('/movies/:movieId', (req: Request, res: Response): void => {
  const { movieId } = req.params;
...
// Get Genre
app.get('/genres/:genreId', (req: Request, res: Response): void => {
...
// Create User List
app.post('/user-lists', (req: Request, res: Response): void => {
  try {
    const input: CreateUserListInput = req.body;
...
// Get User List
app.get('/user-lists/:userListId', (req: Request, res: Response): void => {
...
// Update User List
app.put('/user-lists/:userListId', (req: Request, res: Response): void => {
  const { userListId } = req.params;
  const input: UpdateUserListInput = req.body;
...
// Delete User List
app.delete('/user-lists/:userListId', (req: Request, res: Response): void => {
  const { userListId } = req.params;
...
// Record Watch
app.post('/watch-history', (req: Request, res: Response): void => {
  try {
...
// List Watch History
// eslint-disable-next-line @typescript-eslint/no-unused-vars
app.get('/watch-history', (req: Request, res: Response): void => {
  const history = watchHistory.get('default') || [];
  const response: ListWatchHistoryOutput = {
    entries: history,
  };
  res.json(response);
});
...
// Initiate Stream
app.post('/stream-sessions', (req: Request, res: Response): void => {
  try {
    const input: InitiateStreamInput = req.body;
...
// Get Stream Session
app.get('/stream-sessions/:sessionId', (req: Request, res: Response): void => {
